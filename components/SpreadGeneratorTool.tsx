...
import { ChevronLeft, Zap, Sparkles, Layers } from 'lucide-react';
        ...
        {view === 'input' && (
          <div className="w-full max-w-2xl space-y-12 animate-in fade-in duration-700">
            <header className="space-y-4">
              <h1 className="heading-marker text-7xl md:text-9xl leading-none lowercase">Spread<br/>Generator</h1>
            ...
            <div className="space-y-6">
              ...
              >
                {loadingSpread ? 'Architecting...' : <>Generate Layout <Sparkles size={20} /></>}
              </button>
            </div>
          </div>
        )}
