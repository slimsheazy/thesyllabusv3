...
const SECTORS: Record<string, SectorInfo> = {
  'N': {
    star: 8, label: 'North', color: 'text-marker-blue', icon: <span className="text-lg">[Up]</span>,
  ...
  'S': {
    star: 7, label: 'South', color: 'text-marker-red', icon: <span className="text-lg">[!]</span>,
  ...
  'W': {
    star: 5, label: 'West', color: 'text-yellow-600', icon: <span className="text-lg">[Shield]</span>,
  ...
  'NE': {
    star: 6, label: 'Northeast', color: 'text-marker-black', icon: <span className="text-lg">[Shield]</span>,
  ...
  'SE': {
    star: 2, label: 'Southeast', color: 'text-orange-800', icon: <span className="text-lg">[i]</span>,
    vibe: 'The Sick Bed',
  ...
  'SW': {
    star: 9, label: 'Southwest', color: 'text-marker-purple', icon: <span className="text-lg">[Up]</span>,
  ...
  'C': {
    star: 3, label: 'Center', color: 'text-marker-teal', icon: <span className="text-lg">[Cup]</span>,
              ...
              <div className="space-y-10">
                ...
                <div className="p-6 bg-marker-red/5 marker-border border-marker-red/10 flex flex-col md:flex-row gap-6 items-start md:items-center">
                  <div className="shrink-0 flex items-center gap-2 font-mono text-[9px] font-black uppercase text-marker-red tracking-widest">
                   [Shield] Fixing the vibe
                  </div>                  <p className="handwritten text-lg text-marker-red/80 font-bold italic">
