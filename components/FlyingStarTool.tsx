...
import { Compass, Info, Home, ShieldAlert, Sparkles, TrendingUp, AlertTriangle, Coffee } from 'lucide-react';
          ...
          <div className="max-w-[500px] mx-auto w-full grid grid-cols-3 marker-border border-marker-black bg-white shadow-2xl p-2 relative">
             ...
             {gridOrder.map(id => (
               <BlueprintSector 
                ...
                onClick={() => { setSelectedSector(id); audioManager.playPenScratch(0.05); }} 
               />
             ))}
