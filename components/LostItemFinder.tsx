...
import { Compass, CheckCircle2, MapPin, Package, Clock, Layers, ChevronLeft, Search, RefreshCw } from 'lucide-react';
...
const LostItemFinder: React.FC<{ onBack: () => void }> = ({ onBack }) => {
  ...
  const handleCalculate = async () => {
    ...
    if (inputs.seekerName) setUserIdentity(inputs.seekerName);
